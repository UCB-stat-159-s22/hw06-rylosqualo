...
<html>
  <head>
    ...
    <title>enum — support for enumerations &#8212; My Jupyter Book</title>
  ...
  <link rel="preload" as="script" href="../../../../../../_static/js/index.be7d3bbb2ef33a8344ce.js">
    ...
    <link rel="canonical" href="/user/ryan.keivanfar//proxy/absolute/8000/ligo/lib/python2.7/site-packages/enum/doc/enum.html" />
...
<div class="dropdown-buttons-trigger">
    ...
    <div class="dropdown-buttons">
        ...
        <!-- Download raw file -->
        <a class="dropdown-buttons" href="../../../../../../_sources/ligo/lib/python2.7/site-packages/enum/doc/enum.rst"><button type="button"
...
<a class="full-screen-button"><button type="button" class="btn btn-secondary topbarbtn" data-toggle="tooltip"
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#creating-an-enum">
   Creating an Enum
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#programmatic-access-to-enumeration-members-and-their-attributes">
   Programmatic access to enumeration members and their attributes
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#duplicating-enum-members-and-values">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#allowed-members-and-attributes-of-enumerations">
   Allowed members and attributes of enumerations
  </a>
 </li>
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#restricted-subclassing-of-enumerations">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#derived-enumerations">
   Derived Enumerations
  </a>
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#intenum">
     IntEnum
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#interesting-examples">
   Interesting examples
  </a>
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#autonumber">
     AutoNumber
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#uniqueenum">
     UniqueEnum
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#orderedenum">
     OrderedEnum
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#planet">
     Planet
    </a>
   </li>
  </ul>
 ...
 <li class="toc-h2 nav-item toc-entry">
  <a class="reference internal nav-link" href="#how-are-enums-different">
   How are Enums different?
  </a>
  <ul class="nav section-nav flex-column">
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#enum-classes">
     Enum Classes
    </a>
   </li>
   <li class="toc-h3 nav-item toc-entry">
    <a class="reference internal nav-link" href="#enum-members-aka-instances">
    ...
    <div id="main-content" class="row">
        <div class="col-12 col-md-9 pl-md-3 pr-md-0">
            ...
            <div id="jb-print-docs-body" class="onlyprint">
                <h1>enum — support for enumerations</h1>
                <!-- Table of contents -->
...
<h1><code class="docutils literal notranslate"><span class="pre">enum</span></code> — support for enumerations<a class="headerlink" href="#enum-support-for-enumerations" title="Permalink to this headline">¶</a></h1>
<hr class="docutils" />
...
sets of names and values: <code class="docutils literal notranslate"><span class="pre">Enum</span></code> and <code class="docutils literal notranslate"><span class="pre">IntEnum</span></code>.  It also defines
one decorator, <code class="docutils literal notranslate"><span class="pre">unique</span></code>.</p>
<p><code class="docutils literal notranslate"><span class="pre">Enum</span></code></p>
...
<p><code class="docutils literal notranslate"><span class="pre">IntEnum</span></code></p>
<p>Base class for creating enumerated constants that are also subclasses of <code class="docutils literal notranslate"><span class="pre">int</span></code>.</p>
<p><code class="docutils literal notranslate"><span class="pre">unique</span></code></p>
...
<p>Enumerations are created using the <code class="docutils literal notranslate"><span class="pre">class</span></code> syntax, which makes them
easy to read and write.  An alternative creation method is described in
<a class="reference internal" href="#functional-api">Functional API</a>.  To define an enumeration, subclass <code class="docutils literal notranslate"><span class="pre">Enum</span></code> as
follows:</p>
...
<blockquote>
<div><ul class="simple">
<li><p>The class <code class="docutils literal notranslate"><span class="pre">Color</span></code> is an <em>enumeration</em> (or <em>enum</em>)</p></li>
<li><p>The attributes <code class="docutils literal notranslate"><span class="pre">Color.red</span></code>, <code class="docutils literal notranslate"><span class="pre">Color.green</span></code>, etc., are
<em>enumeration members</em> (or <em>enum members</em>).</p></li>
<li><p>The enum members have <em>names</em> and <em>values</em> (the name of
<code class="docutils literal notranslate"><span class="pre">Color.red</span></code> is <code class="docutils literal notranslate"><span class="pre">red</span></code>, the value of <code class="docutils literal notranslate"><span class="pre">Color.blue</span></code> is
<code class="docutils literal notranslate"><span class="pre">3</span></code>, etc.)</p></li>
</ul>
</div></blockquote>
<p>Note:</p>
<blockquote>
<div><p>Even though we use the <code class="docutils literal notranslate"><span class="pre">class</span></code> syntax to create Enums, Enums
...
<code class="docutils literal notranslate"><span class="pre">__order__</span></code> is supported;  otherwise, value order is used:</p>
...
<p>The <code class="docutils literal notranslate"><span class="pre">__order__</span></code> attribute is always removed, and in 3.x it is also ignored
...
<p>If have an enum member and need its <code class="docutils literal notranslate"><span class="pre">name</span></code> or <code class="docutils literal notranslate"><span class="pre">value</span></code>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">member</span> <span class="o">=</span> <span class="n">Color</span><span class="o">.</span><span class="n">red</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="c1"># python 2.x</span>
...
<p>Allowing aliases is not always desirable.  <code class="docutils literal notranslate"><span class="pre">unique</span></code> can be used to ensure
that none exist in a particular enumeration:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">enum</span> <span class="kn">import</span> <span class="n">unique</span>
...
<p>The special attribute <code class="docutils literal notranslate"><span class="pre">__members__</span></code> is a dictionary mapping names to members.
It includes all names defined in the enumeration, including the aliases:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">for</span> <span class="n">name</span><span class="p">,</span> <span class="n">member</span> <span class="ow">in</span> <span class="nb">sorted</span><span class="p">(</span><span class="n">Shape</span><span class="o">.</span><span class="n">__members__</span><span class="o">.</span><span class="n">items</span><span class="p">()):</span>
...
<p>In Python 2 <em>everything</em> is ordered, even though the ordering may not
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">Mood</span><span class="p">(</span><span class="n">Enum</span><span class="p">):</span>
...
<p>Note:</p>
<blockquote>
<div><p>If your enumeration defines <code class="docutils literal notranslate"><span class="pre">__new__</span></code> and/or <code class="docutils literal notranslate"><span class="pre">__init__</span></code> then
whatever value(s) were given to the enum member will be passed into
those methods.  See <a class="reference internal" href="#planet">Planet</a> for an example.</p>
</div></blockquote>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">enum.test_enum</span> <span class="kn">import</span> <span class="n">Fruit</span>
...
<p>Note:</p>
<blockquote>
<div><p>With pickle protocol version 4 (introduced in Python 3.4) it is possible
to easily pickle enums nested in other classes.</p>
</div></blockquote>
</div>
...
of the call to <code class="docutils literal notranslate"><span class="pre">Enum</span></code> is the name of the enumeration.</p>
...
<p>A variation of <code class="docutils literal notranslate"><span class="pre">Enum</span></code> is provided which is also a subclass of
<code class="docutils literal notranslate"><span class="pre">int</span></code>.  Members of an <code class="docutils literal notranslate"><span class="pre">IntEnum</span></code> can be compared to integers;
...
<p>However, they still can’t be compared to standard <code class="docutils literal notranslate"><span class="pre">Enum</span></code> enumerations:</p>
...
<p>While <code class="docutils literal notranslate"><span class="pre">IntEnum</span></code> is part of the <code class="docutils literal notranslate"><span class="pre">enum</span></code> module, it would be very
...
<p>Some rules:</p>
<ol class="arabic">
<li><p>When subclassing <code class="docutils literal notranslate"><span class="pre">Enum</span></code>, mix-in types must appear before
<code class="docutils literal notranslate"><span class="pre">Enum</span></code> itself in the sequence of bases, as in the <code class="docutils literal notranslate"><span class="pre">IntEnum</span></code>
example above.</p></li>
<li><p>While <code class="docutils literal notranslate"><span class="pre">Enum</span></code> can have members of any type, once you mix in an
additional type, all the members must have values of that type, e.g.
<code class="docutils literal notranslate"><span class="pre">int</span></code> above.  This restriction does not apply to mix-ins which only
add methods and don’t specify another data type such as <code class="docutils literal notranslate"><span class="pre">int</span></code> or
<code class="docutils literal notranslate"><span class="pre">str</span></code>.</p></li>
<li><p>When another data type is mixed in, the <code class="docutils literal notranslate"><span class="pre">value</span></code> attribute is <em>not the
same</em> as the enum member itself, although it is equivalant and will compare
equal.</p></li>
<li><p>%-style formatting:  <code class="docutils literal notranslate"><span class="pre">%s</span></code> and <code class="docutils literal notranslate"><span class="pre">%r</span></code> call <code class="docutils literal notranslate"><span class="pre">Enum</span></code>’s <code class="docutils literal notranslate"><span class="pre">__str__</span></code> and
<code class="docutils literal notranslate"><span class="pre">__repr__</span></code> respectively; other codes (such as <code class="docutils literal notranslate"><span class="pre">%i</span></code> or <code class="docutils literal notranslate"><span class="pre">%h</span></code> for
IntEnum) treat the enum member as its mixed-in type.</p>
<p>Note: Prior to Python 3.4 there is a bug in <code class="docutils literal notranslate"><span class="pre">str</span></code>’s %-formatting: <code class="docutils literal notranslate"><span class="pre">int</span></code>
subclasses are printed as strings and not numbers when the <code class="docutils literal notranslate"><span class="pre">%d</span></code>, <code class="docutils literal notranslate"><span class="pre">%i</span></code>,
or <code class="docutils literal notranslate"><span class="pre">%u</span></code> codes are used.</p>
</li>
<li><p><code class="docutils literal notranslate"><span class="pre">str.__format__</span></code> (or <code class="docutils literal notranslate"><span class="pre">format</span></code>) will use the mixed-in
type’s <code class="docutils literal notranslate"><span class="pre">__format__</span></code>.  If the <code class="docutils literal notranslate"><span class="pre">Enum</span></code>’s <code class="docutils literal notranslate"><span class="pre">str</span></code> or
<code class="docutils literal notranslate"><span class="pre">repr</span></code> is desired use the <code class="docutils literal notranslate"><span class="pre">!s</span></code> or <code class="docutils literal notranslate"><span class="pre">!r</span></code> <code class="docutils literal notranslate"><span class="pre">str</span></code> format codes.</p></li>
</ol>
</div>
</div>
...
<p>A <code class="docutils literal notranslate"><span class="pre">class</span></code> decorator specifically for enumerations.  It searches an
enumeration’s <code class="docutils literal notranslate"><span class="pre">__members__</span></code> gathering any aliases it finds; if any are
found <code class="docutils literal notranslate"><span class="pre">ValueError</span></code> is raised with the details:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nd">@unique</span>
...
<p>While <code class="docutils literal notranslate"><span class="pre">Enum</span></code> and <code class="docutils literal notranslate"><span class="pre">IntEnum</span></code> are expected to cover the majority of
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">AutoNumber</span><span class="p">(</span><span class="n">Enum</span><span class="p">):</span>
...
<p>Note:</p>
<blockquote>
<div><p>The <cite>__new__</cite> method, if defined, is used during creation of the Enum
members; it is then replaced by Enum’s <cite>__new__</cite> which is used after
class creation for lookup of existing members.  Due to the way Enums are
supposed to behave, there is no way to customize Enum’s <cite>__new__</cite>.</p>
</div></blockquote>
</div>
...
alias:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">UniqueEnum</span><span class="p">(</span><span class="n">Enum</span><span class="p">):</span>
...
<p>An ordered enumeration that is not based on <code class="docutils literal notranslate"><span class="pre">IntEnum</span></code> and so maintains
the normal <code class="docutils literal notranslate"><span class="pre">Enum</span></code> invariants (such as not being comparable to other
enumerations):</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">OrderedEnum</span><span class="p">(</span><span class="n">Enum</span><span class="p">):</span>
...
<p>If <code class="docutils literal notranslate"><span class="pre">__new__</span></code> or <code class="docutils literal notranslate"><span class="pre">__init__</span></code> is defined the value of the enum member
will be passed to those methods:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">Planet</span><span class="p">(</span><span class="n">Enum</span><span class="p">):</span>
...
<p>The <code class="docutils literal notranslate"><span class="pre">EnumMeta</span></code> metaclass is responsible for providing the
<code class="docutils literal notranslate"><span class="pre">__contains__</span></code>, <code class="docutils literal notranslate"><span class="pre">__dir__</span></code>, <code class="docutils literal notranslate"><span class="pre">__iter__</span></code> and other methods that
allow one to do things with an <code class="docutils literal notranslate"><span class="pre">Enum</span></code> class that fail on a typical
class, such as <code class="docutils literal notranslate"><span class="pre">list(Color)</span></code> or <code class="docutils literal notranslate"><span class="pre">some_var</span> <span class="pre">in</span> <span class="pre">Color</span></code>.  <code class="docutils literal notranslate"><span class="pre">EnumMeta</span></code> is
responsible for ensuring that various other methods on the final <code class="docutils literal notranslate"><span class="pre">Enum</span></code>
class are correct (such as <code class="docutils literal notranslate"><span class="pre">__new__</span></code>, <code class="docutils literal notranslate"><span class="pre">__getnewargs__</span></code>,
<code class="docutils literal notranslate"><span class="pre">__str__</span></code> and <code class="docutils literal notranslate"><span class="pre">__repr__</span></code>).</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p><code class="docutils literal notranslate"><span class="pre">__dir__</span></code> is not changed in the Python 2 line as it messes up some
...
<code class="docutils literal notranslate"><span class="pre">EnumMeta</span></code> creates them all while it is creating the <code class="docutils literal notranslate"><span class="pre">Enum</span></code>
class itself, and then puts a custom <code class="docutils literal notranslate"><span class="pre">__new__</span></code> in place to ensure
...
<p><code class="docutils literal notranslate"><span class="pre">Enum</span></code> members are instances of an <code class="docutils literal notranslate"><span class="pre">Enum</span></code> class, and even though they
...
return something besides the <code class="docutils literal notranslate"><span class="pre">Enum</span></code> member you were looking for
(changed in version 1.1.1):</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="k">class</span> <span class="nc">FieldTypes</span><span class="p">(</span><span class="n">Enum</span><span class="p">):</span>
...
<p>The <code class="docutils literal notranslate"><span class="pre">__members__</span></code> attribute is only available on the class.</p>
<p>In Python 3.x <code class="docutils literal notranslate"><span class="pre">__members__</span></code> is always an <code class="docutils literal notranslate"><span class="pre">OrderedDict</span></code>, with the order being
the definition order.  In Python 2.7 <code class="docutils literal notranslate"><span class="pre">__members__</span></code> is an <code class="docutils literal notranslate"><span class="pre">OrderedDict</span></code> if
<code class="docutils literal notranslate"><span class="pre">__order__</span></code> was specified, and a plain <code class="docutils literal notranslate"><span class="pre">dict</span></code> otherwise.  In all other Python
2.x versions <code class="docutils literal notranslate"><span class="pre">__members__</span></code> is a plain <code class="docutils literal notranslate"><span class="pre">dict</span></code> even if <code class="docutils literal notranslate"><span class="pre">__order__</span></code> was specified
as the <code class="docutils literal notranslate"><span class="pre">OrderedDict</span></code> type didn’t exist yet.</p>
<p>If you give your <code class="docutils literal notranslate"><span class="pre">Enum</span></code> subclass extra methods, like the <a class="reference internal" href="#planet">Planet</a>
class above, those methods will show up in a <cite>dir</cite> of the member,
but not of the class:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">dir</span><span class="p">(</span><span class="n">Planet</span><span class="p">)</span>
...
<p>A <code class="docutils literal notranslate"><span class="pre">__new__</span></code> method will only be used for the creation of the
<code class="docutils literal notranslate"><span class="pre">Enum</span></code> members – after that it is replaced.  This means if you wish to
change how <code class="docutils literal notranslate"><span class="pre">Enum</span></code> members are looked up you either have to write a
helper function or a <code class="docutils literal notranslate"><span class="pre">classmethod</span></code>.</p>
</div>
</div>
</div>
    ...
    <script type="text/x-thebe-config">
    {
        ...
        kernelOptions: {
            kernelName: "python3",
            path: "./ligo/lib/python2.7/site-packages/enum/doc"
        },
