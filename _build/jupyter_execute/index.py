...
#change to src root
from src.ligotools import readligo as rl
...
from src.ligotools import utils
...
utils.plot(fs,template_p,template_c,time,eventname,template_offset,strain_L1,strain_H1)
